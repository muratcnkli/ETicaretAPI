...
namespace ETicaretAPI.Application.Validators.Products
{
	public class CreateProductValidator:AbstractValidator<VM_Create_Product>
	{
		public CreateProductValidator()
		{
			...
			RuleFor(p => p.Name).MaximumLength(150).MinimumLength(5).WithMessage("Lütfen ürün adını 5 ile 150 karakter arasında giriniz.");
			...
			RuleFor(p => p.Stock).Must(s => s >= 0).WithMessage("Fiyat bilgisi negatif olamaz.");
